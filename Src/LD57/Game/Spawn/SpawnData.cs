...
namespace LD57.Spawn
{
  public class SpawnData
  {
    ...
    {
      return !this.m_obj.Type.Equals("") || 
                !(this.m_obj.GetType() == typeof (TiledMapTileObject)) ? this.m_obj.Type
                : ((TiledMapTileObject) this.m_obj).Tile.Type;
    }
    ...
    public bool HasProperty(string prop)
    {
      if (this.m_obj.Properties.ContainsKey(prop))
        return true;
      return this.m_obj.GetType() == typeof (TiledMapTileObject)
                && ((TiledMapTileObject) this.m_obj).Tile != null
                && ((TiledMapTileObject) this.m_obj).Tile.Properties.ContainsKey(prop);
    }
    ...
    public string GetProperty(string prop, string defaultValue = "")
    {
      ...
      return this.m_obj.GetType() == typeof (TiledMapTileObject) 
                && ((TiledMapTileObject) this.m_obj).Tile != null 
                && ((TiledMapTileObject) this.m_obj).Tile.Properties.ContainsKey(prop) 
                ? (string) ((TiledMapTileObject) this.m_obj).Tile.Properties[prop] : defaultValue;
    }
