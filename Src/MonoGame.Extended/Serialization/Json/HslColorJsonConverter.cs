...
public class HslColorJsonConverter : JsonConverter<HslColor>
{
    ...
    public override HslColor ReadJson(JsonReader reader, Type objectType, HslColor existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
    ...
    public override void WriteJson(JsonWriter writer, HslColor value, JsonSerializer serializer)
    {
        throw new NotImplementedException();
    }
}
