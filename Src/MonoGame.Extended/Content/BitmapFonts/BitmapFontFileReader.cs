...
using System.Text;
using System.Xml;
// Add the following using directive at the top of the file to resolve the CS1061 error.
...
public static class BitmapFontFileReader
{
    ...
    {
        //RnD
        XmlNode node = default;//root.SelectSingleNode("info");
  
        // Explanation:
        // The `SelectSingleNode` method is not part of the `XmlNode` class by default. It is provided by the `System.Xml.XPath` namespace.
        // Adding this using directive will make the `SelectSingleNode` method available for `XmlNode` objects.
    ...
    {
        XmlNode node = default;//root.SelectSingleNode("common");
    ...
    {
        XmlNode nodes = default;//root.SelectNodes("pages/page");
    ...
    {
        XmlNode nodes = default; //root.SelectNodes("chars/char");
        foreach (XmlNode node in nodes)
        {
    ...
    {
        XmlNode nodes = default; //root.SelectNodes("kernings/kerning");
        foreach (XmlNode node in nodes)
        {
    ...
    private static BitmapFontFileContent ReadText(Stream stream)
    {
        ...
        while ((line = reader.ReadLine()) != null)
        {
            ...
            switch (tokens[0])
            {
                //RnD
                case "info":
                    //ReadInfoTokens(bmfFile, tokens.AsSpan()[1..]);
    ...
    private static void ReadKerningTokens(BitmapFontFileContent bmfFile, string v)
    {
        throw new NotImplementedException();
    }

    private static void ReadCharacterTokens(BitmapFontFileContent bmfFile, string v)
    {
        throw new NotImplementedException();
    }

    private static void ReadPageTokens(BitmapFontFileContent bmfFile, string v)
    {
        throw new NotImplementedException();
    }

    private static void ReadCommonTokens(BitmapFontFileContent bmfFile, string v)
    {
        throw new NotImplementedException();
    }

    private static void ReadInfoTokens(BitmapFontFileContent bmfFile, string v)
    {
        throw new NotImplementedException();
    }
